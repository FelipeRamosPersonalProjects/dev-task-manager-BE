...
class Project extends _Global {
    constructor(setup){
        ...
        try {
            const {projectName, description, tickets, repos, tasks, urls, spaceDesk, templates, baseBranch, reviewers} = setup || {};
            ...
            this.reviewers = !Object(reviewers).oid() ? new User(reviewers) : null;
